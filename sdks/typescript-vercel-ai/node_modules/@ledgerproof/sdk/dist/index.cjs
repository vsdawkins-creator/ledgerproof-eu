...
var LedgerProof = class {
  ...
  async lookupByContentHash(contentHash2) {
    const data = await this.transport.request({
      method: "GET",
      path: `/v1/receipts/by-content-hash/${contentHash2}`,
      authenticated: false
    });
    return data?.matches ?? [];
  }
...
exports.GDPRSafetyError = GDPRSafetyError;
exports.KeyManagementError = KeyManagementError;
exports.Keypair = Keypair;
exports.LedgerProof = LedgerProof;
exports.LedgerProofError = LedgerProofError;
exports.NetworkError = NetworkError;
exports.RateLimitError = RateLimitError;
exports.Transport = Transport;
exports.ValidationError = ValidationError;
exports.artifactHash = artifactHash;
