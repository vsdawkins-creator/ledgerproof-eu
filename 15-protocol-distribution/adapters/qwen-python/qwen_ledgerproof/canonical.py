...
class IncrementalTextHasher:
    """
    Stream-aware SHA-256 hasher for streaming Qwen responses (constraint C6).
    ...
    Note for Qwen/DashScope: streaming chunks deliver CUMULATIVE text by default
    (not pure deltas). The client wrapper computes the delta against a running
    prefix and feeds only the new bytes to this hasher.
    """
