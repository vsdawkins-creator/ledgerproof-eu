"""
`@lpr_track` decorator for user functions that wrap a Fireworks chat call.

Use when you already have a function that returns a Fireworks ChatCompletion
...
def lpr_track(
    ...
    *,
    ...
    """
    Decorator factory. The wrapped function MUST return a Fireworks
    ChatCompletion (anything with `.choices[0].message.content`,
    `.id`, `.model`).
