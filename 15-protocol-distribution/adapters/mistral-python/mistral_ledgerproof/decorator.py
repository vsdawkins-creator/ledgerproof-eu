"""
`@lpr_track` decorator for user functions that wrap a Mistral chat call.

Use when you already have a function that returns a Mistral ChatCompletionResponse
...
def lpr_track(
    ...
    *,
    ...
    """
    Decorator factory. The wrapped function MUST return a Mistral
    ...
    Args:
        ...
        eu_sovereignty: Optional EU-sovereign-AI attestation block.
