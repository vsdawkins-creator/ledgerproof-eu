...
Receipts NEVER ride inside the Codestral response payload. They go to one of:
  - LogEmitter — structured stdout/stderr/logger
  - WebhookEmitter — HTTPS POST to deployer-controlled endpoint
  - QueueEmitter — generic callable interface, suitable for SQS/Kafka/Redis/Pub-Sub
  - MultiEmitter — fan out to several emitters
  - StderrEmitter — convenience for development
...
logger = logging.getLogger("mistral_codestral_ledgerproof.emitter")
