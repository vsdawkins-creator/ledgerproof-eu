"""
Ed25519 signer for LedgerProof Codestral receipts.

MVP uses an ephemeral in-process key. Production deployments will plug HSM-backed
signers (AWS KMS, GCP KMS, Azure Key Vault, YubiHSM) via the same `Signer` protocol.
"""
...
class AzureKeyVaultEd25519Signer:
    """Stub for Azure Key Vault-backed Ed25519 signing. Not implemented in MVP."""
