"""Async Groq client wrapper with LedgerProof side-channel receipts."""
...
from .client_wrapper import _pop_lpr, _hash_file_like, _sha256
...
class _AsyncChatCompletionsProxy:
    def __init__(self, parent: "LedgerProofAsyncGroq"):
        self._parent = parent
...
class _AsyncAudioTranscriptionsProxy:
    ...
    async def create(self, *args: Any, **kwargs: Any) -> Any:
        ...
        model = kwargs.get("model", "unknown")
        audio_hash = lpr_opts.get("audio_hash") or _hash_file_like(kwargs.get("file"))
...
class _AsyncAudioProxy:
    def __init__(self, parent: "LedgerProofAsyncGroq"):
        self.transcriptions = _AsyncAudioTranscriptionsProxy(parent)


class LedgerProofAsyncGroq:
    """Async drop-in wrapper around `groq.AsyncGroq`."""
    ...
    def __init__(
        ...
        **groq_kwargs: Any,
        ...
        self._inner = AsyncGroq(api_key=api_key, **groq_kwargs)
        ...
        self.audio = _AsyncAudioProxy(self)

    @property
    def raw(self) -> AsyncGroq:
        return self._inner
    ...
    def _emit_transcription_receipt(self, lpr_opts: dict, model: str,
                                     audio_hash: str, transcript_text: str,
