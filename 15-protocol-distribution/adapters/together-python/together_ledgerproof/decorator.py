"""
`@lpr_track` decorator for user functions that wrap a Together chat call.

Use when you already have a function that returns a Together ChatCompletionResponse
...
def lpr_track(
    ...
    *,
    ...
    """
    Decorator factory. The wrapped function MUST return a Together
    ...
    Args:
        ...
        open_model: Optional open-model attribution block (Meta / Mistral / Qwen / ...).
