"""
`@lpr_track` decorator for user functions that wrap an AI21 chat call.

Use when you already have a function that returns an AI21 ChatCompletionResponse
...
def lpr_track(
    ...
    *,
    ...
    """
    Decorator factory. The wrapped function MUST return an AI21
    ChatCompletionResponse (anything with `.choices[0].message.content`,
    `.id`, `.model`).
    ...
    Args:
        ...
        long_context: Optional long-context attestation block (Jamba 256k window).
        jamba_hybrid: Optional Mamba/Transformer hybrid architecture attestation.
