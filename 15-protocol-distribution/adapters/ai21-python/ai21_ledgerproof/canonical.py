...
class IncrementalTextHasher:
    """
    Stream-aware SHA-256 hasher for streaming AI21 responses (constraint C6).
    ...
    Long-context Jamba streams (up to 256k tokens) cannot be buffered safely;
    this hasher is the only viable signing strategy.
    """
